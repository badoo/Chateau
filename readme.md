...
The architecture of the app is based upon the [principles](https://blog.8thlight.com/uncle-bob/2012/08/13/the-clean-architecture.html) put forward by Robert Martin and adapting this for us with Android.  It providers
...
We decided to keep it simple and simply wire the app together by hand, you can see how in the [ChatExampleApp.java](https://github.com/badoo/Chateau/tree/master/ExampleApp/src/main/java/com/badoo/chateau/example/ChatExampleApp.java).  However of course a DI framework such as [Dagger](https://google.github.io/dagger/) could be used.
...
The main reasons for this descision was:
