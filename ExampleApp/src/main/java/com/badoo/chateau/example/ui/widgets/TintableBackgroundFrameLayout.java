...
public class TintableBackgroundFrameLayout extends FrameLayout implements TintableBackgroundView {

    private final AppCompatBackgroundHelper2 mTintHelper;

    public TintableBackgroundFrameLayout(Context context) {
        this(context, null);
    }

    public TintableBackgroundFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TintableBackgroundFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
